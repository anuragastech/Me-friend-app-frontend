...
const Signup = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-center h-screen bg-gradient-to-r from-indigo-400 via-indigo-500 to-indigo-600 mt-4 mb-14">
              <Navbar/>

      <div className="bg-white rounded-lg shadow-lg flex flex-col md:flex-row w-full max-w-4xl overflow-hidden mb-10">
